...
https://github.com/hsgroup30num1/homework-group-30/tree/6717a2a0772cf36834f761422bbfa66d4cad8929/project18
...
通过analysis可得：交易地址即为创建的测试地址，其中包含hash值，交易的地址，交易的总数，给矿工的费用，收到的时间，input（其中有签名，并且指向使用哪个交易的output），output（包含value也包含了接收方的地址）。<br>

#### 存在问题
在网站https://bitcoinfaucet.uo1.net 试图获取测试用币时并未成功，因此没有成功得到交易数据。
